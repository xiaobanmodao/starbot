...
from actions import web_helpers as _web_helpers
...
def _search_ddg(query: str) -> list[dict]:
    return _web_helpers.search_ddg(query)


def _search_bing(query: str) -> list[dict]:
    return _web_helpers.search_bing(query)


def _do_web_search(query: str) -> list[dict]:
    return _web_helpers.do_web_search(query)


def _extract_html_text(html: str) -> str:
    return _web_helpers.extract_html_text(html)


def _fetch_url_text(url: str) -> str:
    return _web_helpers.fetch_url_text(url)
